...
// Commented out to use custom Clock component
...
Item {
    ...
    MouseArea {
        ...
        // Commented out WallpaperFader to remove blur effect
        // WallpaperFader {
        ...
        // Commented out DropShadow to remove clock shadow
        // DropShadow {
        //     id: clockShadow
        //     anchors.fill: clock
        //     source: clock
        ...
        Clock {
            id: clock
            // property Item shadow: clockShadow  // Commented out shadow reference
        ...
        // Container to position the login block
        Item {
            id: loginContainer
            anchors.fill: parent
            // Move the entire container down
            anchors.topMargin: Kirigami.Units.gridUnit * 17  // Adjust this to move the login block down
